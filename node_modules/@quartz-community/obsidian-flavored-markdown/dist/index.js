...
function tokenizeText(effects, ok32, nok) {
  ...
  function atContentBoundary(code22) {
    ...
    if (isLineEnding3(code22)) {
      return effects.attempt(nonLazyContinuation, atContentBoundary, nok)(code22);
    }
    if (code22 === PERCENT) {
  ...
  return {
    ...
    exit: {
      ...
      comment(token) {
        ...
        node2.value = body3.endsWith("%%") ? body3.slice(0, -MARKER_LENGTH) : body3;
        this.exit(token);
      }
    }
  };
...
function element2(state, node2) {
  ...
  const result = x2(node2.tagName, properties, all3(state, node2.childNodes));
...
var defaultTreeAdapter2 = {
  ...
  setDocumentType(document2, name, publicId, systemId) {
    ...
    if (doctypeNode) {
      ...
      defaultTreeAdapter2.appendChild(document2, node2);
    }
  },
  setDocumentMode(document2, mode) {
    document2.mode = mode;
...
function text5(node2, _2, parent, state) {
