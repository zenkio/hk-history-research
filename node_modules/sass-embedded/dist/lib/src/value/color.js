...
class SassColor extends index_1.Value {
    ...
    constructor(optionsMaybeWithColor) {
        ...
        switch (space) {
            ...
            case 'srgb': {
                ...
                if (this.isRgb) {
                    this.color = new colorjs_io_1.default({
                        ...
                        coords: [red, green, blue].map(rgbToCoord),
                        alpha,
                    });
                }
                else {
            ...
            case 'hsl': {
                ...
                if (saturation !== null && (0, utils_2.fuzzyLessThan)(saturation, 0)) {
            ...
            case 'oklch': {
                ...
                let hue = normalizeHue(options.hue ?? null);
                if (chroma !== null && (0, utils_2.fuzzyLessThan)(chroma, 0)) {
    ...
    get channelsOrNull() {
        ...
        return (0, immutable_1.List)(coords);
    }
    /**
     * A list of this color's channel values (excluding alpha), with [missing
    ...
    get channels() {
        ...
        return (0, immutable_1.List)(coords.map(val => val ?? 0));
    }
    /**
    ...
    get red() {
        ...
        return (0, utils_2.fuzzyRound)(coordToRgb(this.color.srgb.red)) ?? 0;
    }
    /**
    ...
    get green() {
        ...
        return (0, utils_2.fuzzyRound)(coordToRgb(this.color.srgb.green)) ?? 0;
    }
    /**
    ...
    get blue() {
        ...
        return (0, utils_2.fuzzyRound)(coordToRgb(this.color.srgb.blue)) ?? 0;
    }
    /**
